...
for p in positions:
	...
	# Epi-2 setup
	#IJ.run("Image Sequence...", "open="+position_path+"/img_000000000_0-BF_000.tif start="+str(time_range[0])+" number="+str(frame*channel)+" scale=100 sort")	
	...
	if channel == 3:
		...
		IJ.run("Merge Channels...", "c1=C1-Pos"+str(p)+" c2=C2-Pos"+str(p)+" c3=C3-Pos"+str(p)+" c4=C4-Pos"+str(p)+" c5=label create")
	elif channel == 5:
