function dataCycle = foldChangeDNA(dataCycle, varargin)
...
req = ["TRACK_ID","START_INDEX","CYCLE_ID","DNA_SUM_INT_Q90"];
...
for i = 1:numel(ids)
    % disp(i);
    tmpDNAQ90 = T.DNA_SUM_INT_Q90(grp==ids(i));
