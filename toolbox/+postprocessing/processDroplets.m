...
arguments
    ...
    for j = 1:length(uniqueDropletIDs)
        ...
        dropletInfoRows = [dropletInfoRows; [dropletID, nucleiCount, spermCount, medDiam]]; %#ok<AGROW>
        
        fprintf(" - \n");
    end
    
    % Convert droplet info into a table with appropriate variable names.
    dropletInfo = array2table(dropletInfoRows, 'VariableNames', {'TRACK_ID','NUCLEI_COUNT','SPERM_COUNT','MEDIAN_DIAMETER'});
end
